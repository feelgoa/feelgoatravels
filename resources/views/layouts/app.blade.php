        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-nav-first">
                    <li style="display:none;" id="home"><a href="{{ SITE_URL.HOME_URL }}" class="smoothScroll">Home</a>
                    </li>
                    <li id="packages" style="display:none;"><a href="{{ SITE_URL.PACKAGES_URL }}"
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="footer-info">
                        ...
                        <address class="wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <p><a href="{{ SITE_URL.BOOKING_STATUS_URL }}"><i class="fa fa-ticket"></i> Booking status
                                    enquiry</a></p>
                        </address>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-8" style="display:none;">
                    <ul class="wow fadeInUp" data-wow-delay="0.4s" style="list-style-type:none;">
                        <li><a class="fa fa-facebook-square" attr="facebook icon"
                                style="font-size: 100px;cursor:pointer;display:inline-block;margin:0 auto;"></a></li>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="wow fadeInUp copyright-text" data-wow-delay="0.8s">
                        <hr>
                        <p align="center"><br>&copy; 2020 - Feel Goa | Approved by Government of Goa and Recognised by
                            Department of Tourism, Goa</p>
                    </div>
                </div>
            </div>
        </div>
