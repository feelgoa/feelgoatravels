        ...
        <div class="tabs">
            ...
            <div class="tabs__body">
                <div class="tabs__content tab-1 is-active">
                    <hr>
                    @foreach (array_chunk($bike_details, 3) as $chunk)
                    <div class="row">	
                        ...
                        <div class="col-sm-4">
                            <div class="single-cat-widget">
                                ...
                                <div class="overlay1 overlay1-bg"></div>
                                    ...
                                    <div class="thumb">
                                        <img class="content-image img-fluid d-block mx-auto" src="{{$vehicle->vehicle_img}}" alt="">
                                    </div>
                ...
                <div class="tabs__content tab-2">
                    <hr>
                    @foreach (array_chunk($car_details, 3) as $chunk)
                    <div class="row">	
                        @foreach($chunk as $vehicle)
                        <div class="col-sm-4">
                            <div class="single-cat-widget">
