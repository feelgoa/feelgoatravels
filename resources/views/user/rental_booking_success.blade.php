...
<div class="text-center col-md-6" style='background-color: #0000008c;border-radius: 15px;padding: 12px;margin-top: 12px;'>
	...
	<p class="pfont">Your booking request for {{$vehicle->vehicle_name}} {{$vehicle->type}} has been successfully registered. You will receive a response from the Feel Goa team with details on availablity and the payments.</p>
	<p>
	</p>
    @endforeach
 </div>
