...
=======
					<div class="row">
						<div class="optional-info">
							<h4 class="lable-from">Extra Places (Optional)</h4>
							<p style="color: #FFC107;"><strong>Note:</strong> These places are optional and are not included in the package. Extra Charges will be apply. When less than 5 people cab will be provided</p>	
>>>>>>> Stashed changes
						</div>
						<div class="col-sm-6">
							<div class="spot-container">
