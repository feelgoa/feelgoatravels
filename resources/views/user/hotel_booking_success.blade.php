            ...
            <div class="container">
                <div class="row">
                    <div class="text-center col-md-6" style="background-color: #0000008c; border-radius: 15px; padding:12px;">
                        ...
                        <p class="pfont">Your Hotel booking request has been successfully registered. You will receive a response from the Feel Goa team with details on availablity and the payments.</p>
                        <p>
                        </p>
                    </div>
                </div>
